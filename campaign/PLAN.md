...
- **Still to convert:** 12 character-NPCs + the Speaker GM PC (character-typed → the `Character` path); 4 environments (Environment converter, new). Variant pairs Mellan/Savel/Sarru/Mountain Troll → a faithful DSL instance each (owner 2026-09-24).
