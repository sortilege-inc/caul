#!/usr/bin/env bash
# Regenerate data/ from the Daggerheart DSL corpus and prove the round trip.
#
#   bash build/build.sh [<path to titterpig-dsl-daggerheart/0.5>]
#
...
set -euo pipefail
cd "$(dirname "$0")/.."
CORPUS="${1:-$HOME/Sortilege/Titterpig/DSL/titterpig-dsl-daggerheart/0.5}"
